...
<template>
  <div style="height: calc(100vh - 200px); overflow: hidden; overflow-y: auto">
    <div class="row">
      <div class="col-12">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <div class="text-center p-4">
                        ...
                        <p class="text-white-50 font-size-13">Bitcoin prices fell sharply amid the global sell-off
                          in equities. Negative news
