  ...
  <div class="mb-0">
    <div class="row align-items-center">
      ...
      <UTable :items="dataList" :columns="columns" v-model="selectedRow">
        <template #row_shortName="{row}">
          <td>
            <div class="d-flex gap-2">
              <a class="badge bg-primary-subtle text-primary">{{ row?.shortName }}</a>
            </div>
          </td>
        </template>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <UInput v-model="data.name" :label="t('name')" :hint="t('name')" :name="t('name')"
                      :placeholder="t('enter_client_name')" classes="mb-3"/>
            </div>

            <!--            short name-->
            <div class="col-6">
              <UInput v-model="data.shortName" :label="t('shortName')" :hint="t('shortName')" :name="t('shortName')"
                      :placeholder="t('enter_short_name')" classes="mb-3"/>
            </div>

            <!--            phone-->
            <div class="col-6">
              <UInput v-model="data.phone" :label="t('phone_number')" :hint="t('phone_number')" :name="t('phone_number')"
                      :placeholder="t('enter_phone_number')" classes="mb-3"/>
            </div>

            <!--            description-->
            <div class="col-12">
              <UTextarea v-model="data.description" :label="t('description')" :placeholder="t('enter_client_description')"
                         classes="mb-3"/>
            </div>
          </div>
        </form>
