      ...
      <template #body>
        <form class="needs-validation" name="event-form" novalidate="">
          <div class="row">
            <!--            code-->
            <div class="col-6">
              <UInput v-model="data.code" :label="t('project_number')" :hint="t('project_number')" :name="t('project_number')" :placeholder="t('enter') + ' ' + t('project_number')" classes="mb-3" />
            </div>

          <!--            name-->
          <div class="col-12">
            <UInput v-model="data.name" :label="t('project_name')" :hint="t('name')" :name="t('name')" :placeholder="t('enter_project_name') " classes="mb-3" />
          </div>
          ...
          <!--            description-->
          <div class="col-12">
            <UTextarea v-model="data.description" :label="t('description')" :placeholder="t('enter_project_description')" classes="mb-3" />
          </div>
        </div>
      </form>
    </template>
