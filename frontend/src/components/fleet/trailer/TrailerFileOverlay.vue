      ...
      >
        <UForm @submit="saveFile(index)">
          <div class="card-body">
            ...
            <div class="col-md-12">
              <UTextarea v-model="upload.description" placeholder="description"  :readonly="upload.deleted" :noLabel="true" rows="1"/>
            </div>
...
const saveFile = (index) => {
  ...
  axiosIns.post(URIS.TRAILER + "/attach-file", formData)
      .then(() => {
