...
public class DriverFileEntity extends BaseEntity {
    ...
    // for CDL
    public DriverFileEntity(ResourceEntity resource, LocalDate expirationDate, String description, DriverFileTypeEnum type,
                            DriverFileStatusEnum status, DriverEntity driver, String driversLicense, StateEntity state,
                            DriverFileClassEnum classType, LocalDate issuedDate, List<EndorsementEntity> endorsement) {
        this(resource, expirationDate, description, type, status, driver);
    ...
    // for MVR
    // for C/House
    public DriverFileEntity(ResourceEntity resource, LocalDate expirationDate, String description,
                            DriverFileTypeEnum type, DriverFileStatusEnum status, DriverEntity driver,
