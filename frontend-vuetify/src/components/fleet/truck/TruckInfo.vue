...
<template>
  <div class="d-flex ng-star-inserted mt-1">
    <div class="width-50 d-flex flex-column px-3">
      ...
      <div class="two-column-content">
        ...
        <div class="contents">
          ...
          <span class="right"> {{ dataOrTire(data?.stateName) }} </span>
        </div>
        <div class="contents">
        ...
        <div class="contents">
          <span class="left"> Fuel Type: </span>
          <span class="right"> {{ dataOrTire(data?.fuelTypeName) }} </span>
        </div>
        <div class="contents">
          <span class="left"> Gross Weight: </span>
          <span class="right"> {{ dataOrTire(data?.grossWeight) }} </span>
        </div>
        <div class="contents">
      ...
      <div class="two-column-content">
        ...
        <div class="contents">
          <div class="left">Include to the IFTA:</div>
          <div class="right"> {{ data?.includeIFTA ? 'YES' : 'NO' }} </div>
        </div>
      </div>
    ...
    <div class="width-50 d-flex flex-column px-3 truck-info-notes">
      <div class="text-subtitle-1 font-weight-bold mb-3 text-high-emphasis">
        {{ t('additional_notes') }}
      </div>
      <v-sheet
        border
        rounded="lg"
        color="surface"
        class="pa-3 flex-grow-1 min-h-0 truck-info-notes__sheet"
      >
        <div class="text-body-2 text-high-emphasis truck-info-notes__body">
...
.truck-info-notes__sheet {
  max-height: min(42vh, 280px);
}

.truck-info-notes__body {
  overflow-x: hidden;
  overflow-y: auto;
  word-wrap: break-word;
