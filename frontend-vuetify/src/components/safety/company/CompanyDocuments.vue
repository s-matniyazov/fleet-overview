  ...
  <div class="equipment-files-wrapper custom-light-shadow">
    <div class="files-container ng-star-inserted">
      <div class="row justify-content-center align-items-center mb-3">
        ...
        <div class="col-6 font-size-16 text-end">
          <v-btn variant="tonal" prepend-icon="mdi-cloud-download-outline" @click="downloadAll('companyFiles')">
            Download All Files
          </v-btn>
        </div>
      </div>
    ...
    <div class="files-container ng-star-inserted mt-3">
      <div class="row justify-content-center align-items-center mb-3">
        ...
        <div class="col-6 font-size-16 text-end">
          <v-btn variant="tonal" prepend-icon="mdi-cloud-download-outline" @click="downloadAll('companyOtherFiles')">
            Download All Files
          </v-btn>
        </div>
      </div>
    ...
    <template #header>
      <h4 class="fw-bold text-white bg-primary p-2 rounded-2 d-flex">
        ...
        <span class="text-end u-end">
          <v-btn icon variant="text" density="comfortable" aria-label="Close" @click="companyFileStore.init(data.id); selectedFileSection.dialog = false">
